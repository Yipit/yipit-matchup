...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.upset'
        db.add_column('game_game', 'upset',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Game.upset'
        db.delete_column('game_game', 'upset')
    ...
    models = {
        ...
        'game.game': {
            ...
            'ranked': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'upset': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
